...
Your summary must be 5-7 sentences and should address:
    ...
    -> Students might struggle on finding bugs, and rather than using AI to help you understand how the code is structured or works. Students might be tempeted to just ask the AI directly if there is a bug rather than using there debuging skills. It's okay to ask for assitance 

...
Your summary must be 5-7 sentences and should address:
    -> The most concept student might understand is how to use AI as your assistance for your learning ability rather than a reaplcement of your knowledge. 
    -> Students might struggle
    -> AI is helpful to quicly guide and help you understand the structure of the code, and its misleading
